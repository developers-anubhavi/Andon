...
// router.get("/hs_boxes_cumduration", async (req, res) => {
//   try {
//     const pool = await poolPromise;
//     const result = await pool.request().query(`
//       SELECT TOP 1
...
// Fetch latest 60 box names + colors
router.get("/hs_red_count", async (req, res) => {
  try {
    const pool = await poolPromise;
...
// Fetch latest 60 box names + colors
router.get("/hs_red_time", async (req, res) => {
  try {
    const pool = await poolPromise;
